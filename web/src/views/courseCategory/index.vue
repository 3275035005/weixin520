  ...
  <div class="app-container">
    <el-form :inline="true" class="demo-form-inline">
      <el-form-item label="分类名称">
        <el-input v-model="dataVo.title" placeholder="请输入分类名称" />
      </el-form-item>
    ...
    >
      ...
      <el-form :model="formData" label-position="left" label-width="120px">
        <el-form-item label="分类名称">
          <el-input v-model="formData.title" placeholder="请填写分类名称"/>
        </el-form-item>
        <el-form-item label="分类介绍">
          <el-input type="textarea"
                    :rows="5" v-model="formData.description" placeholder="请输入分类介绍"/>
        </el-form-item>
      </el-form>
...
<script>
import { deleteById, insert, update, pageQuery } from '@/api/courseCategory'
