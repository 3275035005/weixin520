  ...
  <div class="app-container">
    <el-form :inline="true" class="demo-form-inline">
      <el-form-item label="轮播图名称">
        <el-input v-model="dataVo.title" placeholder="请输入轮播图名称" />
      </el-form-item>
    ...
    >
      <el-form :model="formData" label-position="left" label-width="120px">
        <el-form-item label="轮播图名称">
          <el-input v-model="formData.title" placeholder="请填写轮播图名称"/>
        </el-form-item>
        <el-form-item label="轮播图顺序">
          <el-input-number v-model="formData.sort" :min="1" :max="1000" label="轮播图顺序"></el-input-number>
        </el-form-item>
...
<script>
import { deleteById, insert, update, pageQuery } from '@/api/banner'
