  ...
  <div class="app-container">
    <el-form :inline="true" class="demo-form-inline">
      <el-form-item label="班级名称">
        <el-input v-model="dataVo.title" placeholder="请输入班级名称" />
      </el-form-item>
    ...
    >
      ...
      <el-form :model="formData" label-position="left" label-width="120px">
        <el-form-item label="班级名称">
          <el-input v-model="formData.title" placeholder="请填写班级名称"/>
        </el-form-item>
      </el-form>
...
<script>
import { deleteById, insert, update, pageQuery } from '@/api/class'
