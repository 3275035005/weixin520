  ...
  <div class="app-container">
    <el-form :inline="true" class="demo-form-inline">
      <el-form-item label="讲师姓名">
        <el-input v-model="dataVo.name" placeholder="请输入讲师姓名" />
      </el-form-item>
    ...
    >
      ...
      <el-table-column align="center" label="讲师照片">
        <template slot-scope="scope">
          <img
      ...
      <el-table-column prop="content" label="讲师短介" />
    ...
    >
      <el-form :model="formData" label-position="left" label-width="100px">
        <el-form-item label="讲师姓名">
          <el-input v-model="formData.name" placeholder="请填写讲师姓名"/>
        </el-form-item>
        <el-form-item label="讲师短介绍">
          <el-input type="textarea"
                    :rows="5" v-model="formData.content" placeholder="请填写讲师短介绍"/>
        </el-form-item>
...
<script>
import { deleteById, insert, update, pageQuery } from '@/api/teacher'
